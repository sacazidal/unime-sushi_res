...
const HotRolls = () => {
  ...
  const sortedItems = [...hotRolls].sort((a, b) => {
    if (sortType === "price") {
  ...
  return (
    <div className="py-10" id={"горячие-роллы"}>
      <Sort
        title="Горячие роллы"
        ...
        {sortedItems.map((item) => (
          ...
          >
            ...
            <div className="absolute top-0 bottom-3 p-5">
              ...
              <p className="py-2 font-montserrat font-medium text-xs max-w-52">
                {item.structure}
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center absolute bottom-2 right-1/4">
